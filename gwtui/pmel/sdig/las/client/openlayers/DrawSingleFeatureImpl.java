 ...
 */
package pmel.sdig.las.client.openlayers;
...
class DrawSingleFeatureImpl {
	...
	public static native JSObject createFeatureAddedCallback(FeatureAddedListener listener)/*-{
		var callback = function(obj){
			...
			listener.@pmel.sdig.las.client.openlayers.DrawSingleFeature.FeatureAddedListener::onFeatureAdded(Lorg/gwtopenmaps/openlayers/client/feature/VectorFeature;)(vectorFeatureObj);
		}
		return callback;
	}-*/;
