...
class GJLocaleSymbols {
    ...
    private static HashMap<Locale, GJLocaleSymbols> cCache = new HashMap<Locale, GJLocaleSymbols>();
...
//        DateFormatSymbols dfs = DateTimeUtils.getDateFormatSymbols(locale);
        ...
        if (locale.getDisplayLanguage().toLowerCase().contains("en")) {
